...
Indiquer le 'layout' de votre application : autrement dit le       
squelette visuel de l'application
...
# textInput(inputId = "lignes", 
 ...
 #                 )
   # ),
```
Ici, nous indiquons l'élement qui sera présent dans la fenêtre #principale : l'element "dataset".
